...
for floor in svgfiles:
	...
	cairosvg.svg2png(url=beavernav + "/SVG Floor Plans/" + floor + ".svg", write_to = beavernav + "/Nontext PNG Floor Plans/" + floor + ".png", background_color="white", dpi=960) # choose on dpi
	...
	#blur = cv2.GaussianBlur(gray, (1,1), 0)
	blur = cv2.Canny(thresh, 50, 200, 3)
