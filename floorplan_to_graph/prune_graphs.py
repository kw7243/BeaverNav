...
def main():
    for graph_name in os.listdir(graph_storage_dir):
        ...
        # if floor_plan != "1_1":
        #     continue
        # if floor_plan.split('_')[0] not in ['1', '3', '10']:
        #     # print(floor_plan.split('-')[0])
        #     continue
        ...
        while len(guarantee_check) < len(room_locations):
            ...
            for iteration in range(2):
                ...
                unreachable_nodes = defaultdict(return_zero)
                # defaultdict on my laptop accepts a CALLABLE, does not accept an int
