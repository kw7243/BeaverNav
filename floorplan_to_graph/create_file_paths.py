...
outdoor_coordinates = beavernav + "backend_file_storage/outdoor_navigation/outdoor_coordinates.json"
outdoor_graph = beavernav + "backend_file_storage/pruned_graphs/0_0_graph.pickle"
distance_scale_dir = beavernav + "backend_file_storage/distance_scale"